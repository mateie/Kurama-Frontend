            ...
            <div className="guild-content">
                ...
                <div>
                    ...
                    <h6 className="mt-0 mb-3">
                        {guild.botJoined ? guild.members.length : "Unknown"}{" "}
                        Members
                    </h6>
                    {!guild.botJoined && (
                        <Button
                            ...
                            onClick={() =>
                                (window.location.href =
                                    "https://discord.com/api/oauth2/authorize?client_id=969414951292788766&permissions=1644971949559&scope=applications.commands%20bot")
                            }
                        />
                    )}
                </div>
